...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("/user/weixin/getUnionId", "anon"); //小程序首頁加载验证
        //filterChainDefinitionMap.put("/user/weixin/getUserInfo", "anon"); //小程序根据身份证号获取信息
        filterChainDefinitionMap.put("/user/weixin/saveRegister", "anon"); //小程序注册接口
        filterChainDefinitionMap.put("/user/weixin/updateInfo", "anon"); //小程序信息修改
        filterChainDefinitionMap.put("/user/weixin/wxGetToken", "anon"); //获取token
